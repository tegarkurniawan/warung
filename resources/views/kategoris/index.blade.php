        ...
        <div class="card-body">
            @if($kategoris->isEmpty())
                <div class="alert alert-info">
                    @if(request('search'))
                        Tidak ada kategori dengan kata kunci "{{ request('search') }}".
                    @else
                        Belum ada kategori.
                    @endif
                </div>
                    ...
                    <table class="table table-vcenter table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($kategori->gambar)
                                        <img src="{{ asset('storage/kategoris/' . $kategori->gambar) }}" alt="{{ $kategori->nama }}" class="img-thumbnail" style="max-width: 50px; height: auto;">
                                    @else
